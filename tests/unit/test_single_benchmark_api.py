...
def client_with_mock_provider(mock_provider_service):
    ...
    from eval_hub.api.routes import get_request_parser, get_evaluation_executor
    from eval_hub.api.routes import get_mlflow_client, get_response_builder
    ...
    def override_response_builder():
        builder = Mock()
        builder.build_response = Mock(return_value=Mock(
            request_id=uuid4(),
            status="pending",
            total_evaluations=1,
...
class TestSingleBenchmarkEvaluation:
    ...
    def test_create_single_benchmark_evaluation_success(self, client_with_mock_provider):
    ...
    def test_create_single_benchmark_evaluation_with_minimal_request(self, client_with_mock_provider):
    ...
    def test_create_single_benchmark_evaluation_benchmark_not_found(self, client_with_mock_provider):
    ...
    def test_create_single_benchmark_evaluation_provider_not_found(self, client_with_mock_provider):
    ...
    def test_create_single_benchmark_evaluation_with_custom_config(self, client_with_mock_provider):
    ...
    def test_create_single_benchmark_evaluation_missing_model_name(self, client_with_mock_provider):
    ...
    def test_create_single_benchmark_evaluation_nemo_evaluator_provider(self, client_with_mock_provider):
